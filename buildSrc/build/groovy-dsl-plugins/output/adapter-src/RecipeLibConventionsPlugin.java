...
/**
 * Precompiled recipe.lib-conventions script plugin.
 **/
public class RecipeLibConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_RecipeLibConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("recipe.java-conventions");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_RecipeLibConventions").asSubclass(BasicScript.class);
